  ...
  return (
    <main className="page-wrap px-4 pt-14 pb-16">
      <section className="island-shell rise-in relative overflow-hidden rounded-4xl px-8 py-12 sm:px-14 sm:py-16">
        ...
        <h1 className="display-title mb-4 text-4xl font-bold tracking-tight text-(--sea-ink) sm:text-5xl">
          Writing
        </h1>
      ...
      <section className="mt-8 flex flex-col gap-4">
        {posts.map(({ slug, title, date, summary }, i) => (
          ...
          >
            <article
              className="island-shell rise-in rounded-2xl p-6 transition hover:-translate-y-0.5 sm:p-8"
