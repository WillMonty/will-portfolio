...
function Home() {
  return (
    <main className="page-wrap px-4 pb-16 pt-14">
      {/* Hero */}
      <section className="island-shell rise-in relative overflow-hidden rounded-[2rem] px-8 py-16 sm:px-14 sm:py-24">
        ...
        <h1 className="display-title mb-6 text-5xl leading-[1.0] font-bold tracking-tight text-[var(--sea-ink)] sm:text-7xl">
          Will Montgomery
        </h1>
